...
<div class="card offset3" style="width: 18rem;">
  <div class="card-body">
  ...
  <div class="row"></div>
  <div class="card offset-3" style="width: 36rem;" >
  <div class="card-body">
    <h5 class="card-title text-center">Remarks</h5>
